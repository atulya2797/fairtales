 ...
 *
 */
class EmployeeEdit extends BaseRequest {
    ...
    public function rules() {
        ...
        $rules = [
            ...
            'EStatus' => 'required',
            'EType' => 'required',
            'EMail' => 'nullable|email|unique:users,email,' . request()->route('eid') . ',EID',
            'password' => 'nullable',
            'confirmPassword' => 'same:password'
        ];
        if (isset($input['EStatus']) && $input['EStatus'] == EmployeeMaster::EStatusLeft) {
            $rules['EDOL'] = 'required';
        }
        ...
        if (isset($input['EDesg'])) {
            ...
            if ($input['EDesg'] == EmployeeEDesg::DESG_TL) {
                $rules['EMail'] = 'required|email|unique:users,email,' . request()->route('eid') . ',EID';
                $rules['Campaign'] = 'required|string';
                $rules['Channel'] = 'in:' . EmployeeMaster::CHANNEL_F2F . ',' . EmployeeMaster::CHANNEL_D2D . ',' . EmployeeMaster::CHANNEL_TMA . ',' . EmployeeMaster::CHANNEL_TMR;
    ...
    public function messages() {
        return [
            ...
            'EDOL.required' => 'Please Enter Date Of leaving.'
        ];
    }
