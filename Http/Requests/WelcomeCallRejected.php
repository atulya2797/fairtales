 ...
 *
 */
class WelcomeCallRejected extends BaseRequest {
...
//        date_format:"Y-m-dH:i"
        ...
        $appliedOutcome = array_diff($getAllOutcome, [SignupWlcmCall::Outcome_Verified, SignupWlcmCall::Outcome_Callback, SignupWlcmCall::Outcome_Call_scheduled_For_Later_Time]);
